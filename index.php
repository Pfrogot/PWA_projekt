...
<h1 style="margin-left:20px">Popis svih karata: </h1>
       ...
       <div style="display: flex;flex-wrap: wrap;flex-direction: row;margin:0px 20px;border:5px solid black;padding:10px;positio;">
            <?php foreach ($xml->Card as $card): ?>
                    ...
                    <?php echo "<p style='visibility:hidden;'>Card type:$card->Type</p>";?>
                    <?php echo "<p style='visibility:hidden;'>Cost:".$card->CardInfo->Cost."</p>" ;?>
                    <?php $broj++;?> 
                    </div> 
                    <?php }?>
                    ...
                    <?php $img=$card->Image;echo "<img width='190' height='200' src='images/$img.jpg'>";?><br>
                    <?php echo "<p style='visibility:hidden;'>Card type:$card->Type</p>";?>
                    <?php echo "<p style='visibility:hidden;'>Subtype:".$card->CardInfo->SubType."</p>" ;?>
                    <?php $broj++;?> 
                    </div> 
                    <?php }?>     
